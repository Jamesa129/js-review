...
// let var1 + var2
// console.log(`prinintg words ${var1}`);
// ================ Variable Names =================
/* 
...
//Unicode is a universal character set that defines the list of characters from the majority of the writing systems, and associates for every character a unique number (code point). https://en.wikipedia.org/wiki/List_of_Unicode_characters
// firstName =`Teddy`
...
// console.log(String.fromCharCode(74,97,109,101,115) +" "+String.fromCharCode(65,98,114,101,117,115));
...
// console.log(string1.endsWith('Scholassssss'))
...
// console.log(pizzaSentence.indexOf(`other`))
...
// console.log(aslDays.substring(aslDays.lastIndexOf('a')));

// trim()
// If only I can use this for my love handles...
// Create a variable with a string value with some extra loving on both sides.
// let newVar1 = '        extra       space        '
